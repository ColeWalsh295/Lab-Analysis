...
reliability <- function(g1, g2, method, type, normalize = FALSE){
...
reliability(g.scan.9.18, g.scan.9.18.DK, method = 'scan-student', 
            type = 'undirected')
reliability(g.scan.9.18, g.scan.9.18.DK, method = 'scan-student', 
...
reliability(g.scan.9.18, igraph::permute(g.scan.9.18.MS,
                                         match(V(g.scan.9.18.MS)$name,
                                               V(g.scan.9.18)$name)), 
            method = 'scan-student', type = 'undirected')
reliability(g.scan.9.18, igraph::permute(g.scan.9.18.MS, 
                                         match(V(g.scan.9.18.MS)$name,
                                               V(g.scan.9.18)$name)), 
            method = 'scan-student', type = 'undirected', normalize = TRUE)
...
reliability(g.skip.9.18, igraph::permute(g.skip.9.18.CW,
                                         match(V(g.skip.9.18.CW)$name,
                                               V(g.skip.9.18)$name)), 
            method = 'skip', type = 'undirected')
reliability(g.skip.9.18, igraph::permute(g.skip.9.18.CW, 
                                         match(V(g.skip.9.18.CW)$name,
                                               V(g.skip.9.18)$name)), 
            method = 'skip', type = 'undirected', normalize = TRUE)
```
...
reliability(g.TA.9.18.Dur.DK, g.TA.9.18.Dur.DW, method = 'scan-group', 
            type = 'directed')
reliability(g.TA.9.18.Dur.DK, g.TA.9.18.Dur.DW, method = 'scan-group', 
...
reliability(g.TA.9.18.No.DK, g.TA.9.18.No.DW, method = 'scan-group', 
            type = 'directed')
reliability(g.TA.9.18.No.DK, g.TA.9.18.No.DW, method = 'scan-group', 
            type = 'directed', normalize = TRUE)
```
