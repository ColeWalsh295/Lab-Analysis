...
plot.graph(g.scan.9.11, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
...
plot.graph(g.scan.9.18, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
...
plot.graph(g.scan.9.25, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
...
plot.graph(g.scan.10.9, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
```
...
plot.graph(g.scan.9.16, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
...
plot.graph(g.scan.9.30, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
...
plot.graph(g.scan.10.7, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
...
plot.graph(g.scan.10.21, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
...
plot.graph(g.scan.10.28, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
```
...
plot.graph(g.skip.9.11, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
...
plot.graph(g.skip.9.18, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
...
plot.graph(g.skip.9.25, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
...
plot.graph(g.skip.10.9, vertex.scale = 20, edge.scale = 5, vertex.label = FALSE)
```
...
g.TA.9.18.Dur.DW <- graph.from.adjacency('C:/Users/Cole/Box Sync/Network analysis/Adjacency_Matrices/P1112_Fall2019/TA_Method/Un_normalized/TA_9_18_Dur_DW.csv', 
                                         method = 'scan-group', directed = TRUE)
plot.graph(g.TA.9.18.Dur.DW, vertex.scale = 20, edge.scale = 5, layout = 'B22',
...
g.TA.9.18.No.DW <- graph.from.adjacency('C:/Users/Cole/Box Sync/Network analysis/Adjacency_Matrices/P1112_Fall2019/TA_Method/Un_normalized/TA_9_18_No_DW.csv', 
                                         method = 'scan-group', directed = TRUE)
plot.graph(g.TA.9.18.No.DW, vertex.scale = 20, edge.scale = 5, layout = 'B22',
           standardNodes = c('TA', 'EveryoneTable'))
...
## Read adjacency matrices and calculate reliability
```{r, warning = FALSE, message = FALSE}
g.scan.group.MS <- graph.from.adjacency('C:/Users/Cole/Box Sync/Network analysis/Adjacency_Matrices/P1116_Fall2017/Scan_Pendulum1_401_MS_adj.csv', 
                                    method = 'scan-group', 
                                    name = 'MS scan-group', directed = TRUE)

g.scan.group.CW <- graph.from.adjacency('C:/Users/Cole/Box Sync/Network analysis/Adjacency_Matrices/P1116_Fall2017/Scan_Pendulum1_401_CW_adj.csv', 
                                    method = 'scan-group', 
                                    name = 'CW scan-group', directed = TRUE)

g.scan.group.DW <- graph.from.adjacency('C:/Users/Cole/Box Sync/Network analysis/Adjacency_Matrices/P1116_Fall2017/Scan_Pendulum1_401_DW_adj.csv', 
                                    method = 'scan-group', 
                                    name = 'DW scan-group', directed = TRUE)

g.scan.group.AH <- graph.from.adjacency('C:/Users/Cole/Box Sync/Network analysis/Adjacency_Matrices/P1116_Fall2017/Scan_PendulumI_401_AH_adj.csv', 
                                    method = 'scan-group', 
...
# B50 layout test
```{r}
g.scan.group.DW <- graph.from.adjacency('C:/Users/Cole/Box Sync/Network analysis/Adjacency_Matrices/P1116_Fall2017/Scan_ForceLaws_402_DW_adj.csv', 
                                    method = 'scan-group', 
                                    name = 'DW scan-group', directed = TRUE)
plot.graph(g.scan.group.DW, vertex.scale = 20, edge.scale = 5, layout = 'B50',
           standardNodes = c('TA', 'EveryoneTable'))
```
